    ...
    public class SeederDB
    {
            ...
            IConfiguration config)
        {
            ...
            using (var scope = services.GetRequiredService<IServiceScopeFactory>().CreateScope())
            {
                ...
                {
                    new Client{Name = "Zahar",Phone = "+380(68)238-80-01",Image = "https://mystatfiles.itstep.org/index.php?view_key=rtILv2awXkYrSQ7WVzOr0G9F1kZwIdRQC03dLrvYiKeqOlHfVfWihS/QG/11CgvGz2Oj7lb/U37S6VWM25ADRgZpjRgGmn2pOd45FJeYozc="},
                    new Client{Name = "Yuri",Phone = "+380(68)278-55-22",Image = "https://mystatfiles.itstep.org/index.php?view_key=rtILv2awXkYrSQ7WVzOr0G9F1kZwIdRQC03dLrvYiKeqOlHfVfWihS/QG/11CgvGz2Oj7lb/U37S6VWM25ADRgZpjRgGmn2pOd45FJeYozc="},
                    new Client{Name = "Maxim", Phone = "+380(97)888-15-97",Image = "https://mystatfiles.itstep.org/index.php?view_key=rtILv2awXkYrSQ7WVzOr0G9F1kZwIdRQC03dLrvYiKeqOlHfVfWihS/QG/11CgvGz2Oj7lb/U37S6VWM25ADRgZpjRgGmn2pOd45FJeYozc="}
                };
